...
- Name: dashboard_stats.spec.js >> Given llm_success_rate between 70 and 90, Then LLM card has warning color
- Location: e2e/dashboard_stats.spec.js:253:1
...
Expected pattern: /color-warning/
Received string:  "#f59e0b"
Timeout: 5000ms

Call log:
  - Expect "toHaveCSS" with timeout 5000ms
  - waiting for locator('.metric-card').nth(3)
    14 × locator resolved to <div class="metric-card">…</div>
       - unexpected value "#f59e0b"

```

```yaml
- text: LLM Success Rate 75% primary backend calls
```
