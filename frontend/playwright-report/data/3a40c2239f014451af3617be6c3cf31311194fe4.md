...
- Name: dashboard_stats.spec.js >> Given llm_success_rate below 70, Then LLM card has danger color
- Location: e2e/dashboard_stats.spec.js:260:1
...
Expected pattern: /color-danger/
Received string:  "#ef4444"
Timeout: 5000ms
...
```yaml
- text: LLM Success Rate 60% primary backend calls
```
